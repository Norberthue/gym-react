...
export default function ExerciseCart(props) {
    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-gradient-to-r from-indigo-500 to-cyan-950 sm:flex-wrap'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
                {['reps', 'rest', 'tempo'].map(info => {
                    return (
                        <div key={info} className='flex flex-col p-2 rounded border-[1.5px] border-solid border-teal-300/50 w-full'>
                ...
                <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px]  border-solid border-blue-600 hover:border-indigo-600 w-full duration-200'>
